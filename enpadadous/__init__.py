...
if __name__ == "__main__":
    ...
    # print(X, y)
    # print(PadatiousSklearn.intent2dataset(X, y, "hello"))
    # print()
    ...
    for intent in ["name", "hello", "who", "joke"]:
    ...
    for sent in test:
        ...
        for i, c in clfs.items():
            p = c.predict([sent.split()])
            if p >= best:
                best = p
                bi = i
        print(bi, "#", sent, best)
        # name # my name is jarbas [0.81281243]
        # who # jarbas is the name [0.70567588]
        # hello # hello bob [0.75137193]
        # who # who are you [0.71250468]
